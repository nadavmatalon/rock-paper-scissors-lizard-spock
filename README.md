...
![](javascript/public/images/footer/heroku_small.png) {float: left;} 
A live version of the game can be found (and played!) at: http://makers-rock-paper-scissors.herokuapp.com 
